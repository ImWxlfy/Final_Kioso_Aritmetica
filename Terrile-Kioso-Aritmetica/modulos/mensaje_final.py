...
def mostrar_mensaje_final(font: pygame.font.Font, screen: pygame.Surface, cambiar_fondo_func, reproducir_sonido_func, sonidos: dict, nombre: str, vidas: int, puntuacion: int, detener_musica_func, current_music: list, WIDTH: int, HEIGHT: int, WHITE: tuple, YELLOW: tuple, RED: tuple, BLACK: tuple) -> None:
    """
    ...
    cambiar_fondo_func(r"Terrile-Kioso-Aritmetica\modulos\assets\fondo_final.png")
    screen.fill(WHITE)
    ...
    reproducir_musica(r"Terrile-Kioso-Aritmetica\modulos\assets\musica_menu.mp3", loop=-1, music_name="menu", current_music=current_music)
