...
def bubble_sort(historial: list) -> list:
    """
...
def mostrar_tabla_puntuaciones(font: pygame.font.Font, small_font: pygame.font.Font, screen: pygame.Surface, cambiar_fondo, OPCIONES_IMAGE: pygame.Surface, reproducir_sonido_func, sonidos: dict, WIDTH: int, HEIGHT: int, BLACK: tuple, GOLD: tuple, SILVER: tuple, BROWN: tuple) -> None:
    """
    ...
    while activo:
        cambiar_fondo(r"Terrile-Kioso-Aritmetica\modulos\assets\fondo_tabla_puntuaciones.png")
