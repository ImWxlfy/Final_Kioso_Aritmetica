...
def ingresar_nombre_usuario(font: pygame.font.Font, small_font: pygame.font.Font, screen: pygame.Surface, cambiar_fondo_func, WIDTH: int, HEIGHT: int, GRAY: tuple, BLACK: tuple) -> str:
    """
    ...
    """
    cambiar_fondo_func(r"Terrile-Kioso-Aritmetica\modulos\assets\fondo_nombre.png")
    nombre = ""
    activo = True
