...
def dibujar_corazones(HEART_IMAGE: pygame.Surface, vidas: int, WIDTH: int, HEIGHT: int, screen: pygame.Surface) -> None:
    """
...
def mostrar_hud(font: pygame.font.Font, small_font: pygame.font.Font, vidas: int, puntuacion: int, nivel: int, ronda: int, ecuacion: str, tiempo_restante: int, tiempo_congelado: bool, HEART_IMAGE: pygame.Surface, ECUACION_BACKGROUND: pygame.Surface, WIDTH: int, HEIGHT: int, screen: pygame.Surface) -> None:
    """
